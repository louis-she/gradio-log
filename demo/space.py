...
_docs = {
    "Log": {
        "description": "Create a log component which can continuously read from a log file and display the content in a container.",
        "members": {
            "__init__": {
                "log_file": {
                    "type": "str",
                    "default": "None",
                    "description": "the log file path to read from.",
                },
                "tail": {
                    "type": "int",
                    "default": "100",
                    "description": "from the end of the file, the number of lines to start read from.",
                },
                "dark": {
                    "type": "bool",
                    "default": "False",
                    "description": "if True, will render the component in dark mode.",
                },
                "label": {
                    "type": "str | None",
                    "default": "None",
                ...
                "every": {
                    "type": "float",
                    "default": "0.3",
                    "description": "New log pulling interval.",
                },
                "show_label": {
                    "type": "bool | None",
                    "default": "None",
        ...
        "events": {
            "load": {
                "type": None,
                "default": None,
                "description": "This listener is triggered when the Log initially loads in the browser.",
            }
        },
    },
    "__meta__": {"additional_interfaces": {}, "user_fn_refs": {"Log": []}},
}
...
```
""",
        elem_classes=["md-custom", "Log-user-fn"],
        header_links=True,
    )
